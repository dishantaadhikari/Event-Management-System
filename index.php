...
<body>
    ...
    <nav>
        <ul>
            <li class="text"> <span style="color:orange" class="display-4 ems">𝔼ᐯ𝔼ᑎ𝕋 ᒍᑌᑎᑕ𝕋𝕀𝕆ᑎ</span>
            </li>
        ...
        <div class="wrapper" id="aboutModal">
            ...
            <div class="team">
                <div class="team_member team_member1">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic nam, eum quam numquam nisi eveniet cum quo quibusdam voluptatibus eligendi aspernatur. Quasi impedit quas quo ipsa dolor nobis hic incidunt iusto voluptas in quis nostrum commodi, nihil doloremque! Molestiae officia neque corrupti perferendis suscipit laborum, incidunt dignissimos consequuntur fugiat. A.</p>
                    <a class="social-link" href="#"><i
                ...
                <div class="team_member team_member2">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic voluptates sapiente at animi aspernatur excepturi incidunt quas porro laborum corrupti qui, dolores expedita doloribus rem aut ex mollitia libero pariatur voluptatum quisquam doloremque ut provident itaque. Natus, totam consequatur? Quaerat nobis ea earum, magnam error hic unde voluptates nam animi!</p>
                    <a class="social-link" href="#"><i
                            class="fa-brands fa-facebook"></i></a>
                    <a class="social-link" href="#"><i class="fa-brands fa-instagram"></i></a>
                    <a class="social-link" href="#"><i
